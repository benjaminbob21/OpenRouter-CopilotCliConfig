...
_launch(){
COPILOT_PROVIDER_BASE_URL="$BOBPILOT_PROVIDER_BASE_URL" COPILOT_PROVIDER_TYPE=openai COPILOT_PROVIDER_API_KEY="$OPENROUTER_API_KEY" COPILOT_MODEL="$1" COPILOT_PROVIDER_WIRE_MODEL="$1" copilot
}
